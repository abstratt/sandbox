...
toDigits n
    | n >= 0 = charListToIntegerList (show n)

charListToIntegerList :: [Char] -> [Integer]
charListToIntegerList [] = []
charListToIntegerList (x:xs) = (toInteger (digitToInt x)) : charListToIntegerList xs
...
isValid n = calcVerifier n == 0

calcVerifier :: Integer -> Integer
calcVerifier n = sumDigits (doubleSecond (toDigitsRev n)) `mod` 10
